...
public class SniperGoldBarrel : ARelics
{
    ...
    public override void Effect()
    {
        foreach (var charater in Player.instance.heroes)
        {
            if (GameManager.instance.heroesPrefab[1].name == charater.name)
            {
                ...
                //Augment the attack by 1%
                charater.GetComponent<ALivings>().maxAttack += (int)((charater.GetComponent<ALivings>().maxAttack / 100f) * 1);
            }
        }
    }
